...
def test_parallel_embedding(model_parallel_size):
    ...
    if torch.distributed.get_rank() == 0:
        print(
            f'> testing parallel embedding with model parallel size {model_parallel_size} ...'
        )
...
def test_initialize_affine_weight(model_parallel_size):
    ...
    if torch.distributed.get_rank() == 0:
        print(
            f'> testing initialize_affine_weight with model parallel size: {model_parallel_size}'
        )
    model_parallel_size = mpu.get_model_parallel_world_size()
...
def test_column_parallel_linear(model_parallel_size):
    ...
    if torch.distributed.get_rank() == 0:
        print(
            f'> testing ColumnParallelLinear with model parallel size: {model_parallel_size}'
        )
    model_parallel_size = mpu.get_model_parallel_world_size()
...
def test_row_parallel_linear(model_parallel_size):
    ...
    if torch.distributed.get_rank() == 0:
        print(
            f'> testing RowParallelLinear with model parallel size: {model_parallel_size}'
        )
    model_parallel_size = mpu.get_model_parallel_world_size()
...
def test_parallel_self_attention(model_parallel_size):
    ...
    if torch.distributed.get_rank() == 0:
        print(
            f'> testing ParallelSelfAttention with model parallel size: {model_parallel_size}'
        )
...
def test_parallel_transformer_layer(model_parallel_size):
    ...
    if torch.distributed.get_rank() == 0:
        print(
            f'> testing ParallelTransformerLayer with model parallel size: {model_parallel_size}'
        )
